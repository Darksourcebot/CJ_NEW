...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━⌞𝙎𝙊𝙐𝙍𝘾𝙀 𝗖𝗝⌝━⊶★━⩺\n\nمرحبا بك في قسم العاب سي چي 3D\n\n⩹━★⊷━⌞𝙎𝙊𝙐𝙍𝘾𝙀 𝗖𝗝⌝━⊶★━⩺"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━⌞𝙎𝙊𝙐𝙍𝘾𝙀 𝗖𝗝⌝━⊶★━⩺\n\n★¦مرحبا بك في قسم العاب سي چي\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━⌞𝙎𝙊𝙐𝙍𝘾𝙀 𝗖𝗝⌝━⊶★━⩺" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب سي چي', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞𝙎𝙊𝙐𝙍𝘾𝙀 𝗖𝗝⌝⚡️', url =f"https://t.me/CG_G11")              
                 ],[
                InlineKeyboardButton(
